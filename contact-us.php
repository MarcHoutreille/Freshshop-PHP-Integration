        ...
        <div class="row">
            <div class="col-lg-8 col-sm-12">
                <div class="contact-form-right">
                    ...
                    <form id="" method="post" action="contact-us.php">
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                if (isset($_POST['submit'])) {
                                    $newFeedback = new UsersContr();
                                    $newFeedback->sendFeedback($_POST['message'],$_POST['name'],$_POST['subject']);
                                    echo "<h3>Thank you very much for you feedback, it is greatly appreciated</h3>";
                                }
                                ?>
